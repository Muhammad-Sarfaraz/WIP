...
<path d="M3.00065168,20.1992055 C3.38825852,15.4265159 7.26191235,13 11.9833413,13 C16.7712164,13 20.7048837,15.2931929 20.9979143,20.2 C21.0095879,20.3954741 20.9979143,21 20.2466999,21 C16.541124,21 11.0347247,21 3.72750223,21 C3.47671215,21 2.97953825,20.45918 3.00065168,20.1992055 Z" fill="#000000" fill-rule="nonzero"></path>
                                ...
                                <div class="wizard-step" data-wizard-type="step" data-wizard-state="{{ Request::is('w/settings/payment')? 'current' : '' }}">
                                    <div class="wizard-wrapper">
                                        <div class="wizard-icon">
                                    ...
                                    <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form">
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="text" class="form-control form-control-solid form-control-lg" name="fname" placeholder="First Name" value="Selim Al">
                                                <span class="form-text text-muted">Your first name.</span>
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="text" class="form-control form-control-solid form-control-lg" name="lname" placeholder="Last Name" value="Adil">
                                                <span class="form-text text-muted">Your last name.</span>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                            <!--end::Input-->
                                            <!--begin::Input-->
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="text" class="form-control form-control-solid form-control-lg" name="address" placeholder="Your address" value="North Dhaka East Coast Near Outer Hatirjheel 12/A">
                                                <span class="form-text text-muted">Your address.</span>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                            <!--end::Input-->
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group fv-plugins-icon-container">
                                                        ...
                                                        <span class="form-text text-muted">Your phone number.</span>
                                                        <div class="fv-plugins-message-container"></div>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group fv-plugins-icon-container">
                                                        ...
                                                        <input type="password" class="form-control form-control-solid form-control-lg" name="password" placeholder="password" value="+61412345678">
                                                        <span class="form-text text-muted">Your password</span>
                                                        <div class="fv-plugins-message-container"></div>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
